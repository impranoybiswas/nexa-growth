    ...
    <main className="pt-24">
      ...
      <section className="section-padding relative overflow-hidden">
        ...
        <motion.div
          ...
          className="container-max relative z-10 text-center max-w-2xl mx-auto"
        >
          <motion.div variants={fadeUp}>
            ...
            <p className="text-white/50 text-lg">
              Tell us about your goals. We'll put together a tailored strategy —
            ...
            >
              ...
              {contactInfo.map(({ icon: Icon, label, value, href }) => (
                <motion.a
                  ...
                  href={href}
                  variants={fadeUp}
                  className="glass-card p-5 flex items-center gap-4 hover:border-white/20 transition-all duration-300 group"
                >
