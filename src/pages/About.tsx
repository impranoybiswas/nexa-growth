...
const values = [
  { icon: Target, title: 'Results-first', desc: 'We measure everything. Vanity metrics don\'t interest us — only outcomes that move your bottom line.' },
  { icon: Heart, title: 'Genuine partnership', desc: 'We\'re not a vendor. We embed into your goals, your challenges, and your vision for growth.' },
  { icon: Trophy, title: 'Excellence always', desc: 'From the first email to the final report — we hold ourselves to a standard we\'re proud of.' },
]
          ...
          <div className="max-w-3xl">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
              ...
              <p className="text-white/50 text-lg leading-relaxed max-w-2xl">
                NexaGrowth was founded on a simple belief: every business deserves a digital strategy that's honest, measurable, and built for the long term. Since 2018, we've helped 200+ companies do exactly that.
              </p>
            </motion.div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-white/50 leading-relaxed mb-6">
                Most agencies are transactional. We're different. We believe the best results come from understanding your business deeply — your customers, your market, your goals — and building a strategy that reflects all of it.
              </p>
              <p className="text-white/50 leading-relaxed">
                That's why our clients stick around. Not because they're locked in, but because they keep growing.
              </p>
            </motion.div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {team.map(({ name, role, bio, avatar, color }, i) => (
              <motion.div
                ...
                className="glass-card p-6 text-center hover:border-white/20 hover:-translate-y-1 transition-all duration-300"
              >
                <div className={`w-16 h-16 rounded-2xl ${color} flex items-center justify-center text-white font-bold text-xl mx-auto mb-4`}>
                  {avatar}
                </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {awards.map(({ year, title, org }, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: i * 0.1 }}
                className="glass-card p-6 hover:border-accent/30 hover:-translate-y-1 transition-all duration-300 group"
              >
      ...
      <section className="section-padding bg-dark-800/30">
        <div className="container-max text-center max-w-2xl mx-auto">
          ...
          <p className="text-white/50 mb-8">
            We take on a limited number of new clients each quarter to maintain quality. Get in touch early.
          </p>
